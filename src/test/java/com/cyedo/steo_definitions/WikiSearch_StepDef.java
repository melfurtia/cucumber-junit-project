...
import com.cyedo.pages.WikiSearchPage;
...
public class WikiSearch_StepDef {
    ...
    public void userTypesInTheWikiSearchBox(String searchBox) {
        wikiSearchPage.searchBox.sendKeys(searchBox);
    }

    @Then("User sees {string} is in the wiki title")
    public void userSeesIsInTheWikiTitle(String wikiTitle) {
        Assert.assertTrue("Title verification is failed!",Driver.getDriver().getTitle().contains(wikiTitle));
